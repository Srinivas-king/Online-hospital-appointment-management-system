...
export const notifyRegistration = async (email, name) => {
...
export const notifyAppointmentBooking = async (email, name, department, date) => {
...
export const notifyAppointmentStatus = async (email, name, status, doctorName, date, time) => {
